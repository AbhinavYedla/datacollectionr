...
if (is.null(gconnect(user, psw))) {
    #If not successful then stop the process
    stop("Login Failed")
}


# gtrendsR library has country list data
country.list <-
...
# Data is little different please refer the note above
# Assuming that respective countries have the highest value in there country domain 
